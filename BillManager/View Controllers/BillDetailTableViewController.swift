...
class BillDetailTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if remindSwitch.isOn {
            ...
            bill.addReminder(remindDate: bill.remindDate!) { (permissionGranted) in
                if permissionGranted.notificationId == nil{
    ...
    func presentNeedAuthorizationAlert(){
        ...
        let message = "Reminders don't work without notifications. Please go to the iOS settings app and grant us notification permissions."
